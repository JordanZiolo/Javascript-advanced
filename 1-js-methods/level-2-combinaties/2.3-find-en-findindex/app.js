...
const warmeTemperatuur = temperaturen.find(temperatuur => temperatuur > 25);
...
const koudeTemperatuur =  temperaturen.find(temperatuur => temperatuur < 20);
console.log('Eerste koude temperatuur:', koudeTemperatuur);

// TODO: Zoek de index van de eerste temperatuur boven 23 graden
const warmeIndex = temperaturen.findIndex(temperatuur => temperatuur > 23);
